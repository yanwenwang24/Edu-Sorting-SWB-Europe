## ------------------------------------------------------------------------
##
## Script name: 02.2.8_dmm_edu3_visualize.jl
...
# Load data
dmm_region_summary = DataFrame(Arrow.Table("Datasets_tidy/dmm_region_edu3_summary.arrow"))
...
save("graphs/dmm_region_edu3.png", f; px_per_unit=2)