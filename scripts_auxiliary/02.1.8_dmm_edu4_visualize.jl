## ------------------------------------------------------------------------
##
## Script name: 02.1.8_dmm_edu4_visualize.jl
...
# Load data
dmm_region_summary = DataFrame(Arrow.Table("Datasets_tidy/dmm_region_edu4_summary.arrow"))
...
save("graphs/dmm_region_edu4.png", f; px_per_unit=2)